		...
		<script type="text/javascript">
			...
			function doDelete(){
				...
				if(rows.length <= 0){
					...
					$.messager.confirm('确认信息','您确定要删除这些数据吗',function(r){
						...
						if(r){
							...
							var ids =  idarrs.join(',');
							alert(ids);
							window.location.href="../../courierAction_delete.action?ids="+ids;
						}
					});
				}
				//alert("删除...");
			...
			$(function(){
				...
				$('#grid').datagrid( {
					...
					pagination : true,
					toolbar : toolbar,
					url : "${pageContext.request.contextPath}/courierAction_findAll.action",
					idField : 'id',
					columns : columns,
	...
	<body class="easyui-layout" style="visibility:hidden;">
		...
		<div class="easyui-window" title="对收派员进行添加或者修改" id="addWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
			...
			<div region="center" style="overflow:auto;padding:5px;" border="false">
				<form id="addCourierForm" method="post" action="../../courierAction_add.action">
